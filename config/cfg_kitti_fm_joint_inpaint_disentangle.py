...
model = dict(
    ...
    min_depth = 0.1,
    max_depth = 100.0,
    depth_pretrained_path = 'F:\\pretrained\\swavresnet{}.pth'.format(DEPTH_LAYERS),# pretrained weights for resnet
    ...
    dis=1e-3,
    cvt=1e-3,
    perception_weight = 0, #1e-3,
    smoothness_weight = 1e-3,
    auto_res_weight = 5e-3,
    disentangle_layers=[True, True, True, True, True],
    skip_connection_multiplier=1,
    depth_skip_type = 'use_half',#'1x1',#'use_half',
    color_skip_type='use_half', #'use_half',#'half_use',
    color_skip_layers=[True, True, True, True] , #[False, False, False, False],#[False, True, True, True],
